...
from infinityMusicBot.modules.play import generate_cover
from infinityMusicBot.modules.play import arq
from infinityMusicBot.modules.play import cb_admin_check
from infinityMusicBot.modules.play import transcode
from infinityMusicBot.modules.play import convert_seconds
from infinityMusicBot.modules.play import time_to_seconds
from infinityMusicBot.modules.play import changeImageSize
from infinityMusicBot.config import BOT_NAME as bn
from infinityMusicBot.config import DURATION_LIMIT
from infinityMusicBot.config import UPDATES_CHANNEL as updateschannel
from infinityMusicBot.config import que
from infinityMusicBot.function.admins import admins as a
from infinityMusicBot.helpers.errors import DurationLimitError
from infinityMusicBot.helpers.decorators import errors
from infinityMusicBot.helpers.admins import get_administrators
...
from infinityMusicBot.helpers.gets import get_file_name
from infinityMusicBot.services.callsmusic import callsmusic
from infinityMusicBot.services.callsmusic import client as USER
from infinityMusicBot.services.converter.converter import convert
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        user.first_name = "infinityMusicBot"
    usar = user
    wew = usar.id
    try:
        # chatdetails = await USER.get_chat(chid)
